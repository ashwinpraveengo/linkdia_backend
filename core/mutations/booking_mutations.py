...
class CreateBookingInput(graphene.InputObjectType):
    ...
    consultation_type = graphene.String(required=True)  # ONLINE or OFFLINE
    ...
    def mutate(self, info, input):
        ...
        try:
            with transaction.atomic():
                ...
                if input.consultation_type not in ['ONLINE', 'OFFLINE']:
                    return CreateBookingMutation(
                        success=False,
                ...
                consultation_fee = professional.pricing.get_fee_for_duration(duration_minutes)
                
                # Add extra fee for offline consultation if applicable
                if input.consultation_type == 'OFFLINE' and hasattr(professional.pricing, 'offline_consultation_extra'):
                    consultation_fee += professional.pricing.offline_consultation_extra
